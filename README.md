...
| <a name="requirement_google"></a> [google](#requirement\_google) | >= 3.53, < 7.0 |

## Modules

| Name | Source | Version |
|------|--------|---------|
| <a name="module_cfe_role"></a> [cfe\_role](#module\_cfe\_role) | terraform-google-modules/iam/google//modules/custom_role_iam | 8.0.0 |
